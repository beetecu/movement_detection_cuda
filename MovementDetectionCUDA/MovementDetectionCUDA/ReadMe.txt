========================================================================
    APLICACIÓN DE CONSOLA: MovementDetectionCUDA Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación MovementDetectionCUDA.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación MovementDetectionCUDA.


MovementDetectionCUDA.vcxproj
...
MovementDetectionCUDA.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado MovementDetectionCUDA.pch y un archivo de tipos precompilados llamado StdAfx.obj.

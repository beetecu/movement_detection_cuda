...
*
* OpenCV & CUDA. Real time movement detection 
...
static void help()
{
	printf("\nDo movement detection using CUDA functions.\n"
		"Segment the scene backgroung based on background subtraction.\n"
		"Usage: \n"
		"            ./MovementDetectionCUDA[--camera]=<use camera, if this key is present>, [--file_name]=<path to movie file> \n\n");
}
